...
public partial class masterPageTrangChu : System.Web.UI.MasterPage
{
 ...
 <div class='modal__item' id='madong_" + r[1].ToString().Trim() + @"'>
    ...
    void loadThanhToan()
    {
        ...
        if (cookie == null || cookie["checkDN"].ToString().Equals(""))
        {
        ...
        {
            if (cookie["qtc"].ToString().Trim().Equals("admin"))
            {
        ...
        else
        {
            ...
            DataTable tb = khacHang.layThongTinKHTheoEmail(cookie["email"].ToString());
            lbEmail.Text = cookie["email"].ToString();
    ...
    protected void btnTiepTheo_Click(object sender, EventArgs e)
    {
        ...
        DataTable tb = khacHang.layThongTinKHTheoEmail(cookie["email"].ToString());
        lbEmailNguoiMua.Text = cookie["email"].ToString();
    ...
    {
        string values = "";
        if (cookie == null || cookie["email"].Equals("") || cookie["qtc"].ToString().Equals("admin"))
            return values;
        DataTable tb = khacHang.layThongTinKHTheoEmail(cookie["email"].ToString().Trim());
        values = @"
