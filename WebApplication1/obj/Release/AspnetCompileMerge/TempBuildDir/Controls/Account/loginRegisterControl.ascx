<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="loginRegisterControl.ascx.cs" Inherits="WebApplication1.Controls.Account.loginRegisterControl" %>
<asp:MultiView ID="MultiView1" runat="server">
    <asp:View ID="vwLogin" runat="server">
        <div class="login">
            ...
            <div class="login__group">
                <p></p>
                <div class="login__group-group">
                    <input runat="server" id="txtCaptcha" placeholder="Nhập mã" />
                    <a href="javascript:reload()" class="icon_captcha">
                        <i class="fas fa-sync-alt"></i>
                    </a>
                    <img style="text-align: center;" id="capt" src="captcha.aspx" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ValidationGroup="login" ControlToValidate="txtCaptCha" Text="Vui lòng nhập mã bảo vệ" Display="Dynamic" runat="server" ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
                </div>
                </div>
...
<script language="javascript" type="text/javascript">
    //hàm load lại mã captcha
    function reload() {
        var img = document.getElementById("capt");
        img.src = "captcha.aspx?" + Math.random();
    }
    //hàm xem mật khẩu
    function open() {
